...
var enter
var zumbi, zumbis = [], zumbis_morte, Calvo_OAnim,Calvo_MAnim,CalvoAnim, CarequinhaAnim, CarecaoAnim, Calvo_ParadoImg, Calvo_M_ParadoImg
//const ValorTF = 5
var tiro = "nada", score = 0, descalvicificados = 0, streak = 0, maxStreak = 0, streaks = [], maxscore = 0
var Ztiro, tiros = []
var alvo_player 
...
var maxStreakTxt,scoreTxt,vidasTxt,descalvicificadosTxt,moedasTxt,streakTxt
var ArmaAtual
...
function preload(){
  ...
  acertouSom = loadSound("sons/calvo levando tiro.mp3")
  acertouSom2 = loadSound("sons/calvo levando tiro2.mp3")
  acertouSom3 = loadSound("sons/calvo levando tiro3.mp3")
  ...
  CarecaoAnim = loadAnimation("Assets/Carecão/Carecão1.png","Assets/Carecão/Carecão2.png","Assets/Carecão/Carecão3.png","Assets/Carecão/Carecão4.png","Assets/Carecão/Carecão5.png")
  ...
  if(maxStreak< streak){
    ...
    if(gamemode == "over"){
      ...
      /*if((zumbis.length == 0 && tiros.length == 0 && fogos.length == 0 && alertas.length == 0)==true){
        ...
        fill("red")
        text("descalvicificados = " + descalvicificados, width/2-300, 700)
        fill("red")
...
function setAllGameElements(){
  ...
  descalvicificadosTxt = createElement("h2")
  descalvicificadosTxt.class("marcadorPartida")
  descalvicificadosTxt.position(444.472, 60)
...
function TxtHtml(){
  ...
  descalvicificadosTxt.html("descalvicificados = " + descalvicificados)
  ...
  if(frameCount % 30 === 0 && zumbis.length < 40 && aviso == true){
    ...
    if(valor == 1){
      ...
      setTimeout(() => {
        ...
        zumbis.push(zumbi)
        zumbi.body.addAnimation("perseguir", CarecaoAnim)
        zumbi.body.addAnimation("feliz", Player_parado)
...
/*function boss(){
  if(descalvicificados % 0 == 0 && descalvicificados !==0 && !luta_de_chefe){
